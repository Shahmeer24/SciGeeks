...
const AnimatedSection = ({ children, animationClass }) => {
  ...
  useEffect(()=>{
    document.title="Home | SciGeeks";
  });

  return (
    <div
      ref={ref}
      className={`transition-all duration-1000 ${animationClass} ${
...
const Home = () => {
  ...
  const featuredCourses = [
    {
      ...
      description:
        "Comprehensive preparation for ISI B.Stat/B.Math entrance exams.",
      image: "https://placehold.co/600x400/e2e8f0/475569?text=Math+Course",
    },
    {
      title: "NEST & IISER Aptitude",
      description:
        "Complete course for National Entrance Screening Test and IAT.",
      image: "https://placehold.co/600x400/e2e8f0/475569?text=Science+Course",
    },
    {
      title: "Research Methodology",
      description:
        "Advanced course on scientific research methods and statistics.",
  ...
  const institutes = [
    {
      name: "ISI",
      logo: "https://placehold.co/200x100/ffffff/475569?text=ISI",
    },
    {
      name: "CEBS",
      logo: "https://placehold.co/200x100/ffffff/475569?text=CEBS",
    },
    {
      name: "IISER",
      logo: "https://placehold.co/200x100/ffffff/475569?text=IISER",
    },
    {
      name: "IISc",
      logo: "https://placehold.co/200x100/ffffff/475569?text=IISc",
    },
    {
      name: "CMI",
      logo: "https://placehold.co/200x100/ffffff/475569?text=CMI",
    },
    {
      name: "NISER",
      logo: "https://placehold.co/200x100/ffffff/475569?text=NISER",
    },
  ];
      ...
      <section className="relative h-screen flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-30 text-center px-4">
          ...
          <p className="text-lg md:text-xl max-w-3xl mx-auto text-slate-200 mb-8">
            <strong>SciGeeks</strong> is your trusted partner in preparing for
            top science entrance exams like the IISER Aptitude Test (IAT) and
            National Entrance Screening Test (NEST). Powered by JAM Coaching
            Kolkata, we provide expert-guided courses, comprehensive study
            materials, and targeted practice to help school students achieve
            their dream of studying at premier science National and
            International institutions. Join us today to kickstart your
            scienctific career.
          </p>
          <div className="relative">
            <Link
              to="/courses"
              className="inline-flex items-center gap-2 bg-white text-slate-800 font-semibold px-8 py-3 mx-2 my-2 rounded-md hover:bg-slate-200 transition-colors duration-300"
            >
          ...
          <AnimatedSection animationClass="translate-y-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-slate-800 dark:text-white">
                Explore Our Premier Courses
              </h2>
              <p className="mt-4 text-lg text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
                Kickstart your journey with our most popular and comprehensive
                programs.
              </p>
            </div>
              ...
              {featuredCourses.map((course, index) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <Link
                      to="/courses"
                      className="font-semibold text-slate-600 dark:text-slate-300 hover:text-slate-800 dark:hover:text-white transition-colors"
                    >
                      Learn More &rarr;
                    </Link>
                  </div>
      ...
      <section className="py-16 sm:py-24 bg-slate-50 dark:bg-gray-800">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-300 mb-12">
            We collaborate with the best to provide you with unparalleled
            opportunities.
          </p>
        </div>
        <div
          className={`relative w-full overflow-hidden ${styles.carouselContainer}`}
        >
          ...
          <AnimatedSection animationClass="opacity-0">
            <div className="bg-slate-600 dark:bg-gray-800 rounded-lg p-8 md:p-12 text-center">
              ...
              <p className="text-slate-200 mb-8 max-w-2xl mx-auto">
                Subscribe to our newsletter for the latest courses, research
              ...
              >
                ...
                <button
                  ...
                  className="bg-white text-slate-800 font-semibold px-6 py-3 rounded-md hover:bg-slate-200 transition-colors duration-300 cursor-pointer"
                >
